...
class UsageTrackingService {
  ...
  DocumentReference? get _usageRef {
    final uid = _uid;
  ...
  Future<int> getInvoiceCount() async {
    ...
    return (doc.data() as Map<String, dynamic>?)?['invoicesCreated'] as int? ?? 0;
  }
  ...
  Future<int> getWhatsAppShareCount() async {
    ...
    final doc = await ref.get();
    if (!doc.exists) return 0;
    return (doc.data() as Map<String, dynamic>?)?['whatsappShares'] as int? ?? 0;
  }
