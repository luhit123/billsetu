...
class AppStrings {
  ...
  String get drawerCustomersDesc => _t(
    ...
    as_:
        'গ্ৰাহকৰ নাম, ফোন নম্বৰ, GSTIN আৰু টোকা সংৰক্ষণ কৰক যাতে বিল দ্ৰুতকৈ বনাব পাৰি।',
  );
  ...
  String get settingsHubSubtitle => _t(
    ...
    as_:
        'এজন ঠাইৰ পৰাই আপোনাৰ ব্যৱসায়িক প্ৰফাইল, বিলিং টুল, ভাষা আৰু সহায় পৰিচালনা কৰক।',
  );

  String get settingsQuickActionsTitle =>
      _t(en: 'Quick actions', hi: 'त्वरित विकल्प', as_: 'দ্ৰুত বিকল্প');
  ...
  String get settingsAboutBody => _t(
    ...
    as_:
        'দ্ৰুত বিলিং, GST-সাজু তথ্য আৰু সৰল দৈনন্দিন কামৰ বাবে তৈয়াৰ কৰা হৈছে।',
  );

  String get settingsHelpTitle =>
      _t(en: 'Need help?', hi: 'मदद चाहिए?', as_: 'সহায় লাগিব নেকি?');
  ...
  String get settingsHelpBody => _t(
    ...
    as_:
        'ওপৰৰ চৰ্টকাট ব্যৱহাৰ কৰি এটা টেপত প্ৰফাইল, বিলিং, GST আৰু কেটালগ স্ক্ৰীণ খোলক।',
  );
  ...
  String pdfItemsCount(int n) =>
      _t(en: '$n item${n == 1 ? '' : 's'}', hi: '$n वस्तु', as_: '$n সামগ্ৰী');
  ...
  String get detailsItems => _t(en: 'Items', hi: 'वस्तुएं', as_: 'সামগ্ৰীসমূহ');
  ...
  String get detailsSubtotal => _t(en: 'Subtotal', hi: 'उप-योग', as_: 'উপ-মুঠ');
  ...
  String get homeTitle => _t(en: 'Dashboard', hi: 'डैशबोर्ड', as_: 'ডেশব\'ৰ্ড');

  String get homeMonthlyRevenue =>
      _t(en: 'Monthly Revenue', hi: 'मासिक आय', as_: 'মাহেকীয়া আয়');

  String get homeQuickActions =>
      _t(en: 'Quick Actions', hi: 'त्वरित कार्य', as_: 'দ্ৰুত কাৰ্য');

  String get homeCreateInvoice =>
      _t(en: 'Create Invoice', hi: 'चालान बनाएं', as_: 'বিল তৈয়াৰ কৰক');

  String get homeAddClient =>
      _t(en: 'Add Client', hi: 'ग्राहक जोड़ें', as_: 'গ্ৰাহক যোগ কৰক');

  String get homeRecentInvoices =>
      _t(en: 'Recent Invoices', hi: 'हाल के चालान', as_: 'শেহতীয়া বিলসমূহ');

  String get homeBottomHome => _t(en: 'Home', hi: 'होम', as_: 'হোম');
  String get homeBottomInvoices =>
      _t(en: 'Invoices', hi: 'चालान', as_: 'বিলসমূহ');
  String get homeBottomClients =>
      _t(en: 'Customers', hi: 'ग्राहक', as_: 'গ্ৰাহক');
  String get homeBottomProducts =>
      _t(en: 'Products', hi: 'उत्पाद', as_: 'সামগ্ৰী');
  String get homeBottomSettings =>
      _t(en: 'Settings', hi: 'सेटिंग', as_: 'ছেটিং');

  String get homeViewAll =>
      _t(en: 'View All', hi: 'सभी देखें', as_: 'সকলো চাওক');
  ...
  String get gstReportTitle =>
      _t(en: 'GST Report', hi: 'GST रिपोर्ट', as_: 'GST প্ৰতিবেদন');
  ...
  String get gstReportPeriodLabel =>
      _t(en: 'Period', hi: 'अवधि', as_: 'সময়কাল');

  String get gstReportMonthly =>
      _t(en: 'Monthly', hi: 'मासिक', as_: 'মাহেকীয়া');

  String get gstReportQuarterly =>
      _t(en: 'Quarterly', hi: 'त्रैमासिक', as_: 'ত্ৰৈমাসিক');

  String get gstReportYearly => _t(en: 'Yearly', hi: 'वार्षिक', as_: 'বাৰ্ষিক');

  String get gstReportTaxableAmount =>
      _t(en: 'Taxable Amount', hi: 'कर योग्य राशि', as_: 'করযোগ্য পৰিমাণ');

  String get gstReportTotalCgst =>
      _t(en: 'Total CGST', hi: 'कुल CGST', as_: 'মুঠ CGST');

  String get gstReportTotalSgst =>
      _t(en: 'Total SGST', hi: 'कुल SGST', as_: 'মুঠ SGST');

  String get gstReportTotalIgst =>
      _t(en: 'Total IGST', hi: 'कुल IGST', as_: 'মুঠ IGST');
  ...
  String get gstReportCgstSgst =>
      _t(en: 'CGST + SGST', hi: 'CGST + SGST', as_: 'CGST + SGST');

  String get gstReportIgst => _t(en: 'IGST', hi: 'IGST', as_: 'IGST');
  ...
  String get gstReportInterstate =>
      _t(en: 'Interstate', hi: 'अंतरराज्यीय', as_: 'আন্তঃৰাজ্যিক');
  ...
  String get gstReportSelectMonth =>
      _t(en: 'Select Month', hi: 'महीना चुनें', as_: 'মাহ বাছক');

  String get gstReportSelectQuarter =>
      _t(en: 'Select Quarter', hi: 'तिमाही चुनें', as_: 'ত্ৰৈমাস বাছক');

  // ── Profile GSTIN ────────────────────────────────────────────────────────────

  String get profileGstinLabel =>
      _t(en: 'GSTIN (optional)', hi: 'GSTIN (वैकल्पिक)', as_: 'GSTIN (ঐচ্ছিক)');
  ...
  String get drawerPurchases =>
      _t(en: 'Purchases', hi: 'खरीद', as_: 'ক্ৰয়');

  String get purchasesTitle =>
      _t(en: 'Purchase Orders', hi: 'खरीद आदेश', as_: 'ক্ৰয় আদেশ');
